...
public class AdapterClass3rd extends RecyclerView.Adapter<AdapterClass3rd.MyViewHolder>{

    //1 . Data source :
    private ModelClass2nd[] listDATA;

    public AdapterClass3rd(ModelClass2nd[] listView) {
    ...
    @NonNull
    @Override
    public AdapterClass3rd.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext()) ;
        View listItem = layoutInflater.inflate(R.layout.arash_list , parent , false) ;
        AdapterClass3rd.MyViewHolder viewHolder = new MyViewHolder(listItem) ;

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterClass3rd.MyViewHolder holder, int position) {
